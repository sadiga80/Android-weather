package com.appsan.weather_info.widgets;
...
import com.appsan.weather_info.BuildConfig;
import com.appsan.weather_info.activities.MainActivity;
...
public class TimeWidgetProvider extends AbstractWidgetProvider {
    ...
    private static final String ACTION_UPDATE_TIME = "com.appsan.weather_info.UPDATE_TIME";
